...
- **添加脚本**: 点击顶部<img width="93" height="28" alt="image" src="https://github.com/user-attachments/assets/3cdf0de6-5938-45bb-820b-0dd1762763d7" />
按钮，填写脚本信息
- **编辑脚本**: 右键点击脚本卡片选择"编辑"
- **删除脚本**: 右键点击脚本卡片选择"删除"
- **搜索脚本**: 使用顶部搜索框
...
- **创建定时任务**: 点击顶部<img width="27" height="24" alt="image" src="https://github.com/user-attachments/assets/fceb3b7f-4242-4a36-8119-d40f538ebb2a" />
按钮，选择"新建任务"
...
- **配置仓库**: 点击顶部<img width="29" height="23" alt="image" src="https://github.com/user-attachments/assets/f79cbfa6-8ef5-4743-b3ed-4e2a8006954f" />
按钮，选择"仓库配置"（可配置多个仓库分别对应不同的密钥，实现脚本分类管理）
- **下载脚本**: 配置好仓库密钥后，就可以加载对应仓库下的脚本压缩文件
- **上传脚本**: 用户也可以上传写好的脚本到仓库供授权的用户下载使用
